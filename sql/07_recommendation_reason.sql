-- Goal output:
-- player_name, position, vorp, scarcity_adjustment, 
-- roster_need_adjustment, recommendation_score, recommendation_reason

-- Example:
-- Recommendation Reason:
-- High VORP + scarce position + roster need
-- High Vorp + roster need
-- Depth option; lower roster priority

-- Answer: Who is valuable, scarce, and a good fit for my roster?
-- 1) What position does the team already have?
-- 2) What position does the team need?
-- 3) Should available players at needed positions get a boost?
-- Example: 
-- a) If Team 1 has 0 players at a position, add +8
-- b) If Team 1 has 1 player at a position, add +4
-- c) If Team 1 has 2+ players at a position, add +0
